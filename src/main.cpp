...
void exibirMenuAtendente(SistemaLocadora &sistema)
{
    ...
    while (opcao != 9)
    {
        ...
        {
        case 1:
            atendente_cadastrar_cliente(sistema);
            break;
        case 2:
            atendente_consultar_disponiveis(sistema);
            break;
        case 3:
            atendente_criar_contrato(sistema);
            break;
        case 4:
            atendente_finalizar_contrato(sistema);
            break;
        case 9:
...
void exibirMenuGerente(SistemaLocadora &sistema)
{
    ...
    while (opcao != 9)
    {
        ...
        {
        case 1:
            gerente_cadastrar_agencia(sistema);
            break;
        case 2:
            gerente_cadastrar_veiculo(sistema);
            break;
        case 3:
            gerente_listar_agencias_e_frotas(sistema);
            break;
        case 4:
            gerente_transferir_veiculo(sistema);
            break;
        case 5:
            gerente_otimizar_frota(sistema);
            break;
        case 9:
            std::cout << "Voltando..." << std::endl;
            break;
